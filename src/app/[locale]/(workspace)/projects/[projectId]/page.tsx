...
export default function ProjectPage() {
  ...
  const teamMembers = useMemo(() => {
    const people = [project?.owner, ...(project?.members || [])].filter(Boolean)
    return Array.from(new Map(people.map((person: any) => [String(person._id), person])).values())
  }, [project])
      ...
      <div className="relative z-10 space-y-6">
        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-3">
          ...
          <div className="space-y-5 lg:col-span-2">
            <Card className="overflow-hidden rounded-2xl border border-slate-200/70 bg-transparent shadow-sm dark:border-slate-800/80 dark:bg-transparent">
          ...
          <div className="space-y-4">
            ...
            <Card className="overflow-hidden rounded-2xl border border-slate-200/70 bg-transparent shadow-sm dark:border-slate-800/80 dark:bg-transparent">
              <CardHeader className="p-5 pb-3">
                <CardTitle className="text-base font-black">Project Details</CardTitle>
                <CardDescription className="text-[9px] font-black tracking-widest text-slate-400 uppercase">
                  Status, ownership and delivery
                </CardDescription>
              </CardHeader>
            ...
            <Card className="overflow-hidden rounded-2xl border border-slate-200/70 bg-transparent shadow-sm dark:border-slate-800/80 dark:bg-transparent">
              <CardHeader className="p-5 pb-3">
                <CardTitle className="text-base font-black">Schedule Health</CardTitle>
                <CardDescription className="text-[9px] font-black tracking-widest text-slate-400 uppercase">
              ...
              <CardContent className="space-y-3 p-5 pt-0">
                <div className="grid grid-cols-2 gap-3">
                  <div className="rounded-xl bg-rose-50/60 p-3 dark:bg-rose-950/20">
                    <div className="mb-1 flex items-center gap-1.5 text-rose-600">
                  ...
                  <div className="rounded-xl bg-blue-50/60 p-3 dark:bg-blue-950/20">
                ...
                {upcomingTasks.length === 0 ? (
                  <p className="rounded-xl bg-slate-50/50 px-3 py-3 text-sm font-medium text-slate-500 dark:bg-slate-950/30">
            ...
            <Card className="overflow-hidden rounded-2xl border border-slate-200/70 bg-transparent shadow-sm dark:border-slate-800/80 dark:bg-transparent">
              <CardHeader className="p-5 pb-3">
                <div className="flex items-center justify-between">
                  <div>
                    <CardTitle className="text-base font-black">Contributors</CardTitle>
                    <CardDescription className="text-[9px] font-black tracking-widest text-slate-400 uppercase">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-[10px] font-black tracking-widest text-slate-400 uppercase">
                        {member.organizationRole ||
                          (String(member._id) === String(project.owner?._id) ? "OWNER" : "MEMBER")}
                      </p>
                    </div>
                  </div>
                ))}
            ...
            <Card className="overflow-hidden rounded-2xl border border-slate-200/70 bg-transparent shadow-sm dark:border-slate-800/80 dark:bg-transparent">
              <CardHeader className="p-5 pb-3">
                <CardTitle className="text-base font-black">Useful Links</CardTitle>
                <CardDescription className="text-[9px] font-black tracking-widest text-slate-400 uppercase">
                  Core project views
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-2 p-5 pt-0">
                {[
                  { label: "Board", desc: "Manage tasks in Kanban", href: "board" },
                  { label: "Tasks", desc: "See the full task list", href: "tasks" },
                  { label: "Calendar", desc: "Review deadlines", href: "calendar" }
                ].map((item) => (
                  <Link key={item.href} href={`/${locale}/projects/${projectId}/${item.href}`}>
                    <div className="flex items-center justify-between rounded-xl bg-slate-50/50 px-3 py-3 transition-colors hover:bg-slate-50/80 dark:bg-slate-950/30 dark:hover:bg-slate-950/50">
                      <div>
